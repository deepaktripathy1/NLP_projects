...
Original file is located at
    https://colab.research.google.com/drive/1fl-f6bq9B0RjXfirhYNkP786fitxyjV7

## Image Clustering

This example shows how SentenceTransformers can be used for Image Clustering.
...
cos_scores.topk(k=min_community_size, largest=True)
...
top_val,top_id = cos_scores[0].topk(k=1000,largest=True)
top_val = top_val.tolist()
top_id = top_id.tolist()

len(top_val),len(top_id)
